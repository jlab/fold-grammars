...
echo "#RNAalifold#"
/vol/pi/bin/memtime64 /vol/pi/bin/RNAalifold-2.1.2 -d 0 2>&1 < "$inputFile" 

echo "#RNAalifold-p#"
/vol/pi/bin/memtime64 /vol/pi/bin/RNAalifold-2.1.2 -d 0 -p 2>&1 < "$inputFile" 

cd '/vol/cluster-data/sjanssen/bin/';

echo "#ali_oa_i_nodangle_mfepp#"
/vol/pi/bin/memtime64 /vol/cluster-data/sjanssen/bin/ali_oa_i_nodangle_mfepp -u 1 "$bgapInputInside" 2>&1

echo "#ali_oa_i_nodangle_pfunc#"
/vol/pi/bin/memtime64 /vol/cluster-data/sjanssen/bin/ali_oa_i_nodangle_pfunc -u 1 "$bgapInputInside" 2>&1

echo "#ali_oa_o_nodangle_pfunc#"
/vol/pi/bin/memtime64 /vol/cluster-data/sjanssen/bin/ali_oa_o_nodangle_pfunc -u 1 -o=/dev/null "$bgapInputOutside" 2>&1
