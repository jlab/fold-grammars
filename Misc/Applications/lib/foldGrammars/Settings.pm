...
our %PROGINFOS = (
	...
	'libfoldgrammars', 	{date => '31.10.2013', version => '1.0.12', name => 'libfoldgrammars', packageDir => 'libfoldGrammars/'},
	'rapidshapes', 			{date => '16.11.2013', version => '2.0.2', name => 'RapidShapes', packageDir => 'RapidShapes/'},
