...
our %PROGINFOS = (
	...
	'pkiss', 						{date => '23.11.2013', version => '2.2.5', name => 'pKiss', packageDir => 'pKiss/'},
	'libfoldgrammars', 	{date => '25.11.2013', version => '1.0.21', name => 'libfoldgrammars', packageDir => 'libfoldGrammars/'},
