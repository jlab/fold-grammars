...
algebra alg_pfunc implements sig_foldrna(alphabet = char, answer = answer_macrostate_pfunc) {
  ...
  answer_macrostate_pfunc gquad(Subsequence G1, Subsequence l1, Subsequence G2, Subsequence l2, Subsequence G3, Subsequence l3, Subsequence G4) {
    answer_macrostate_pfunc res;
    return res;
  }
  answer_macrostate_pfunc gquadflank(Subsequence lb, Subsequence left, answer_macrostate_pfunc x, Subsequence right, Subsequence rb; int danglemodel) {
    return x;
  }
}

algebra alg_pfunc_filter_me extends alg_pfunc {
